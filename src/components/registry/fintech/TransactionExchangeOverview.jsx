    ...
    <section className="relative w-full max-w-4xl overflow-hidden rounded-[30px] border border-white/10 bg-[#06101c] p-5 shadow-2xl shadow-black/40 sm:p-6">
      ...
      <div className="relative">
        <div className="flex flex-col gap-5 border-b border-white/[0.08] pb-5 sm:flex-row sm:items-end sm:justify-between">
          ...
          <button className="inline-flex items-center gap-2 self-start rounded-xl bg-white px-4 py-2.5 text-xs font-bold text-slate-950 transition hover:-translate-y-0.5 sm:self-auto">
        ...
        <div className="grid gap-3 py-5 lg:grid-cols-[1.4fr_.6fr]">
          <div className="overflow-hidden rounded-[22px] border border-white/[0.08] bg-white/[0.025]">
            <div className="flex items-center justify-between border-b border-white/[0.07] px-4 py-3.5">
              ...
              <button className="inline-flex items-center gap-1 text-[10px] font-medium text-slate-600 hover:text-white">Details <ChevronRight className="h-3 w-3" /></button>
            </div>
