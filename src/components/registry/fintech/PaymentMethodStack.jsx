...
export default function PaymentMethodStack() {
  return <section className="w-full max-w-lg rounded-[28px] border border-white/10 bg-[#08111d] p-5 shadow-2xl shadow-black/35 sm:p-6">
