...
export default function PricingTierCard(){
  return <section className="relative w-full max-w-md overflow-hidden rounded-[30px] border border-violet-300/20 bg-[#080f1c] p-1 shadow-2xl shadow-violet-950/25">
    <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-violet-400/15 to-transparent"/>
    <div className="relative rounded-[26px] border border-white/10 bg-black/10 p-5 sm:p-6">
      <div className="flex items-center justify-between"><div className="inline-flex items-center gap-2 rounded-full border border-violet-300/20 bg-violet-300/10 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-violet-200"><Crown className="h-3.5 w-3.5"/>Pro</div><Sparkles className="h-5 w-5 text-violet-300"/></div>
      ...
      <button className="mt-6 w-full rounded-2xl bg-gradient-to-r from-cyan-300 to-violet-300 px-4 py-3 text-sm font-bold text-slate-950 transition hover:scale-[1.01]">Start building</button>
