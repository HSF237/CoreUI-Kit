...
export default function CommandPalette(){
  return <section className="w-full max-w-xl overflow-hidden rounded-[24px] border border-white/10 bg-[#070f1b]/95 shadow-2xl shadow-black/50 backdrop-blur-2xl">
