...
export default function MagneticActionButtons(){
  return <section className="w-full max-w-2xl rounded-[28px] border border-white/10 bg-[#07101c] p-6 shadow-2xl shadow-black/35">
    ...
    <div className="mt-5 flex flex-wrap gap-3">
      ...
      <button className="group inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-300 to-violet-300 px-4 py-3 text-sm font-bold text-slate-950 shadow-lg shadow-cyan-950/30 transition hover:-translate-y-0.5"><Sparkles className="h-4 w-4"/>Generate with AI</button>
      ...
      <button className="group relative inline-flex items-center gap-2 overflow-hidden rounded-2xl border border-cyan-300/20 bg-cyan-300/[0.07] px-4 py-3 text-sm font-semibold text-cyan-100 transition hover:-translate-y-0.5"><span className="absolute inset-0 translate-y-full bg-cyan-300/10 transition group-hover:translate-y-0"/><Zap className="relative h-4 w-4 text-cyan-300"/><span className="relative">Quick deploy</span></button>
    </div>
  </section>
}
