...
export default function SearchFilterBar(){
  return <section className="w-full max-w-4xl rounded-[24px] border border-white/10 bg-[#07101c] p-4 shadow-2xl shadow-black/35">
    <div className="flex flex-col gap-3 lg:flex-row">
      <label className="flex h-11 min-w-0 flex-1 items-center gap-2 rounded-xl border border-white/10 bg-white/[0.025] px-3 focus-within:border-cyan-300/30"><Search className="h-4 w-4 text-slate-600"/><input placeholder="Search projects, owners, tags..." className="min-w-0 flex-1 bg-transparent text-sm text-slate-200 outline-none placeholder:text-slate-700"/></label>
      <div className="flex flex-wrap gap-2">
        ...
        <button className="inline-flex h-11 items-center gap-2 rounded-xl border border-cyan-300/20 bg-cyan-300/[0.07] px-3 text-xs font-medium text-cyan-200"><SlidersHorizontal className="h-3.5 w-3.5"/>2 filters</button>
      </div>
    </div>
