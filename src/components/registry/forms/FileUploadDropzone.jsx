...
export default function FileUploadDropzone(){
  return <section className="w-full max-w-xl rounded-[28px] border border-white/10 bg-[#07101c] p-5 shadow-2xl shadow-black/35 sm:p-6">
    ...
    <button className="mt-5 flex w-full flex-col items-center rounded-[22px] border border-dashed border-cyan-300/25 bg-cyan-300/[0.035] px-6 py-9 text-center transition hover:bg-cyan-300/[0.06]"><span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-300/10 text-cyan-300"><UploadCloud className="h-5 w-5"/></span><span className="mt-4 text-sm font-semibold text-slate-200">Drop files here or browse</span><span className="mt-1 text-xs text-slate-600">PNG, JPG, SVG, PDF up to 10MB</span></button>
