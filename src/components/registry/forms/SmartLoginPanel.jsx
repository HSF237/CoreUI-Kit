...
export default function SmartLoginPanel(){
  return <section className="w-full max-w-md overflow-hidden rounded-[30px] border border-white/10 bg-[#07101c] p-1 shadow-2xl shadow-black/40">
    <div className="rounded-[26px] border border-white/10 bg-black/10 p-5 sm:p-6">
      <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-300 to-violet-300 text-slate-950"><Sparkles className="h-5 w-5"/></div>
      ...
      <div className="mt-6 space-y-3">
        <label className="flex h-12 items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.025] px-4 focus-within:border-cyan-300/30"><Mail className="h-4 w-4 text-slate-600"/><input type="email" placeholder="you@company.com" className="min-w-0 flex-1 bg-transparent text-sm text-slate-200 outline-none placeholder:text-slate-700"/></label>
        <label className="flex h-12 items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.025] px-4 focus-within:border-cyan-300/30"><LockKeyhole className="h-4 w-4 text-slate-600"/><input type="password" placeholder="Password" className="min-w-0 flex-1 bg-transparent text-sm text-slate-200 outline-none placeholder:text-slate-700"/></label>
      </div>
